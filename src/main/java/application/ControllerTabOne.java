...
public class ControllerTabOne {
    ...
    void initialize() {
    	...
    	btnClose.setOnAction(e->{System.gc();System.exit(0);});
        btnOpenFileForGet.setOnAction(e->{openFileForGetPath();});
        ...
        btnCloseConnect.setOnAction(e->{try {
        ...
        btnDecOrder.setOnAction(e->{orderDec();
        try {
			getDateInTableView(Quantiti, Offset);
		} catch (SQLException e1) {
			e1.printStackTrace();
